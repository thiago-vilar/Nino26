...
ARTIFACTS = [
    ...
    Artifact(
        ...
        "Tabela de eventos OISST; insumo para reclassificacao P90/P95",
        "peak_time",
        "events",
        None,
        regular=False,
        key_cols=("peak_monthly_ssta_c",),
    ),
    Artifact(
        "picos_p90_oisst",
        FEAT / "nino34_oisst_p90_peaks.csv",
        "Picos mensais >= P90 local",
        "peak_time",
        "peaks",
        None,
        regular=False,
        key_cols=("peak_nino34_anom_c", "percentile_threshold_c"),
    ),
    Artifact(
        "picos_p95_oisst",
        FEAT / "nino34_oisst_p95_peaks.csv",
        "Picos mensais >= P95 local",
        "peak_time",
        "peaks",
        None,
        regular=False,
