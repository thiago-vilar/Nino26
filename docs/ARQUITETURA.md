...
| Rotulo ENSO externo | Fora das metricas. Eventos, referencia mensal e picos P90 saem da OISST baixada. |
| Graficos oficiais Nino 3.4 | Mantidos em `docs/assets/figures/official_nino34/` para comparativo visual, excluidos de metricas, eventos, P90 e diagnosticos. |
| Eventos | Derivados de `nino34_daily_oisst.csv` por agregacao mensal local. |
| P90 | Calculado sobre `nino34_monthly_oisst.csv`. |
...
| Picos P90 OISST locais | `data/processed/parquet/features/nino34_oisst_p90_peaks.csv` |
| Grafico P90 OISST local | `docs/assets/figures/nino34_oisst_p90_peaks.png` |
