...
| 3B | Como eventos nascem, crescem, picam e decaem? Quanta memoria ha? | taxas por evento, trajetorias compostas nas 3 medias, e-folding, mapa composto de pico |
...
| 3G | (extra) Como o ciclo de vida se relaciona com o DHW C-week? | metricas por fase de evento, composto SSTA/DHW nas 3 medias, escalonamento, mapa DHW-lon |
| 3H | (extra) Que estado fisico precede o onset? A genese separa `forte_p90` de `super_p95`? | compostos onset-alinhados nas 3 medias, retrato precursor por classe, separacao Spearman |
| 3K | (extra) Quais variaveis explicam o crescimento pre-pico? | PCA, loadings e conjunto indispensavel para crescimento |
| 3I | Qual e a interpretacao integrada da Fase 3? Como comparar P90/P95 e 2026? | conclusoes executivas, tabela P90/P95, 3 medias executivas, estado 2026, texto para parecer |
...
pico mensal >P95. Regra fixa de leitura por medias/compostos:
...
As tabelas de referencia ficam em `phase3B_grupos_medias_elnino.csv`,
`phase3G_composto_ssta_dhw_tres_medias.csv`,
`phase3H_grupos_medias_elnino.csv` e `phase3I_tres_medias_elnino.csv`
(`phase3I_media_eventos_gt_p90.csv` e mantida por compatibilidade).
